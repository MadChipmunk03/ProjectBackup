...
namespace Projekt_Daemon.Functions
{
    public class FTP
    {
        ...
        public void RunFTP(string FTPDestination, string Source, NetworkCredential Login)
        {
            ...
            if (Directory.Exists(tempfolder) != true)
            {
                ...
                Console.WriteLine($"[{DateTime.Now}] Created tempfolder");
            }
            tempfolder = tempfolder + $"{this.BackupName}.zip";
            if (File.Exists(tempfolder))
            {
                File.Delete(tempfolder);
                Console.WriteLine($"[{DateTime.Now}] REDELETED TEMPFOLDER");
            }
